  ...
  server: {
    ...
    proxy: {
      ...
      '/api/proxy/gitee_raw': {
        ...
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/gitee_raw/, ''),
        headers: { ...commonHeaders, referer: 'https://gitee.com/' },
      },
      '/api/proxy/gitee': {
        target: 'https://gitee.com',
      ...
      '/api/proxy/gequbao': {
        target: 'https://www.gequbao.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/gequbao/, ''),
        headers: { ...commonHeaders, referer: 'https://www.gequbao.com/', origin: 'https://www.gequbao.com' },
      },
      // ============ 放屁音乐网 ============
      '/api/proxy/fangpi': {
        target: 'https://www.fangpi.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/fangpi/, ''),
        headers: { ...commonHeaders, referer: 'https://www.fangpi.com/', origin: 'https://www.fangpi.com' },
      },
      // ============ Tonzhon 搜索 ============
      '/api/proxy/tonzhon': {
        target: 'https://tonzhon.com',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/api\/proxy\/tonzhon/, ''),
        headers: { ...commonHeaders, referer: 'https://tonzhon.com/' },
      },
      // ============ 布谷音乐镜像 ============
      '/api/proxy/buguomusic': {
